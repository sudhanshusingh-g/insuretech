...
const GovernmentWaitingPolicies = ({ handleClaimRequest, governmentRequestedList }) => {
    return (
        <>
            {governmentRequestedList?.waitingForGovernmentPolicies?.length == 0 ?
                (
                    <div
                        style={{
                            height: "100%",
                ...
                : (
                    ...
                    >
                        ...
                        <tbody>
                            {governmentRequestedList?.waitingForGovernmentPolicies
                                ?.map((item) => {
                                        ...
                                        >
                                            ...
                                            >
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        const payload = {
                                                            id: item?.claimDetails?.claimId,
                                                            action: "approve",
                                                        };
                                                        handleClaimRequest(payload);
                                                    }}
                                                    disabled={item?.policyStatus == "fulfilled"}
                                                >
                                                    Accept
                                                </Button>
                                                <Button
...
export default GovernmentWaitingPolicies